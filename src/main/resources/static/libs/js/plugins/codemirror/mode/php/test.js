...
(function() {
  ...
  var m1 = build_recursive_monsters(
    ['[string "][variable-2 $]{[variable aaa] [My_order +] ', '}[string "]'],
  ...
  var m2 = build_recursive_monsters(
    ['[string "a][variable-2 $]{[variable aaa] [My_order +] ', ' [My_order +] ', '}[string .a"]'],
  ...
  var m3 = build_recursive_monsters_2(
    m1,
    m2,
    ['[string "a][variable-2 $]{[variable aaa] [My_order +] ', ' [My_order +] ', ' [My_order +] ', '}[string .a"]'],
    '[comment /* }?>{{ */] [string "a?>}{{aa][variable-2 $aaa][string .a}a?>a"]',
    4
  );
